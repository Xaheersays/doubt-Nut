...
const Report = () => {
  ...
  return (
    <div className='border bg-gray-900 p-4 rounded-md h-96 overflow-auto my-2  scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-slate-300  overflow-y-scroll  '>
